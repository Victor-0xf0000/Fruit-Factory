...
{
   tileSystem->getTile(this->x-1,  this->y)->nearbyUpdate(0.f, tileSystem);
   tileSystem->getTile(this->x+1,  this->y)->nearbyUpdate(0.f, tileSystem);
   tileSystem->getTile(this->x-1,this->y-1)->nearbyUpdate(0.f, tileSystem);
   tileSystem->getTile(this->x+1,this->y+1)->nearbyUpdate(0.f, tileSystem);
   tileSystem->getTile(this->x,  this->y-1)->nearbyUpdate(0.f, tileSystem);
   tileSystem->getTile(this->x,  this->y+1)->nearbyUpdate(0.f, tileSystem);
   tileSystem->getTile(this->x+1,this->y-1)->nearbyUpdate(0.f, tileSystem);
   tileSystem->getTile(this->x-1,this->y-1)->nearbyUpdate(0.f, tileSystem);
}
